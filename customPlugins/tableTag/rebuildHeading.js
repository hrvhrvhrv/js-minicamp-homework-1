...
import ListBuilderEditing from './rebuildheadingediting.js';
import ListBuilderUI from './rebuildheadingui.js';
 ...
 */
export default class ListBuilder extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
		return [ ListBuilderEditing, ListBuilderUI ];
	}
